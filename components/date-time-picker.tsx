...
import { Calendar as CalendarIcon, ChevronLeft, ChevronLeftCircleIcon, ChevronRight, ChevronRightCircleIcon } from 'lucide-react';
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: (props) => <ChevronLeftCircleIcon className="h-4 w-4" />,
        IconRight: (props) => <ChevronRightCircleIcon className="h-4 w-4" />,
        // HeadRow
        // HeadRow: () => <div className='flex justify-between w-full'>
