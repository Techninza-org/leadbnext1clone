...
//         //     const documents = adminDeptForm?.filter((doc: any) => doc.name === 'Document');
//         //     const fields = documents[0]?.subDeptFields || [];
//         //     //@ts-ignore
//         //     filteredLeads = filteredLeads?.filter((lead: any) => {
//         //         const feedback = lead.submittedForm[0]?.feedback || [];
...
//         //     const documents = adminDeptForm?.filter((doc: any) => doc.name === 'Reporting');
//         //     const fields = documents[0]?.subDeptFields || [];
//         //     //@ts-ignore
//         //     filteredLeads = filteredLeads?.filter((lead: any) => {
//         //         const feedback = lead.submittedForm[0]?.feedback || [];
...
//                                 <SelectItem value="all">All</SelectItem>
//                                 {
//                                     adminDeptForm?.map((dept: { id: Key | null | undefined; name: string }) => (
