...
export function BarGraph({ className }: { className: string }) {
  ...
  const [userInfo] = useAtom(userAtom)
    ...
    // console.log(data?.getLeadsByDateRange?.groupedCallPerday, 'grouped');
    ...
    <Card className={className}>
      <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          ...
          <CardDescription>
            Showing total calls made per day in last 60 days
          </CardDescription>
        </div>
        {/* <div className="flex">
